...
// checks if the ListInternalNetworks500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListInternalNetworks500Response{}
...
type _ListInternalNetworks500Response ListInternalNetworks500Response
...
func NewListInternalNetworks500Response() *ListInternalNetworks500Response {
	this := ListInternalNetworks500Response{}
	return &this
}
...
func (o *ListInternalNetworks500Response) UnmarshalJSON(data []byte) (err error) {
	varListInternalNetworks500Response := _ListInternalNetworks500Response{}

	err = json.Unmarshal(data, &varListInternalNetworks500Response)

	if err != nil {
		return err
	}

	*o = ListInternalNetworks500Response(varListInternalNetworks500Response)
...
type NullableListInternalNetworks500Response struct {
	value *ListInternalNetworks500Response
	isSet bool
}

func (v NullableListInternalNetworks500Response) Get() *ListInternalNetworks500Response {
	return v.value
}

func (v *NullableListInternalNetworks500Response) Set(val *ListInternalNetworks500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalNetworks500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalNetworks500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalNetworks500Response(val *ListInternalNetworks500Response) *NullableListInternalNetworks500Response {
	return &NullableListInternalNetworks500Response{value: val, isSet: true}
}
