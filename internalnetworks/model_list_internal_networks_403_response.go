...
// checks if the ListInternalNetworks403Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListInternalNetworks403Response{}
...
type _ListInternalNetworks403Response ListInternalNetworks403Response
...
func NewListInternalNetworks403Response() *ListInternalNetworks403Response {
	this := ListInternalNetworks403Response{}
	return &this
}
...
func (o *ListInternalNetworks403Response) UnmarshalJSON(data []byte) (err error) {
	varListInternalNetworks403Response := _ListInternalNetworks403Response{}

	err = json.Unmarshal(data, &varListInternalNetworks403Response)

	if err != nil {
		return err
	}

	*o = ListInternalNetworks403Response(varListInternalNetworks403Response)
...
type NullableListInternalNetworks403Response struct {
	value *ListInternalNetworks403Response
	isSet bool
}

func (v NullableListInternalNetworks403Response) Get() *ListInternalNetworks403Response {
	return v.value
}

func (v *NullableListInternalNetworks403Response) Set(val *ListInternalNetworks403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalNetworks403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalNetworks403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalNetworks403Response(val *ListInternalNetworks403Response) *NullableListInternalNetworks403Response {
	return &NullableListInternalNetworks403Response{value: val, isSet: true}
}
