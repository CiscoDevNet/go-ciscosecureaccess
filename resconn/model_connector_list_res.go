...
// checks if the ConnectorListRes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorListRes{}
...
type _ConnectorListRes ConnectorListRes
...
func (o *ConnectorListRes) UnmarshalJSON(data []byte) (err error) {
	varConnectorListRes := _ConnectorListRes{}

	err = json.Unmarshal(data, &varConnectorListRes)

	if err != nil {
		return err
	}

	*o = ConnectorListRes(varConnectorListRes)
...
type NullableConnectorListRes struct {
	value *ConnectorListRes
	isSet bool
}

func (v NullableConnectorListRes) Get() *ConnectorListRes {
	return v.value
}

func (v *NullableConnectorListRes) Set(val *ConnectorListRes) {
	v.value = val
	v.isSet = true
}
...
func NewNullableConnectorListRes(val *ConnectorListRes) *NullableConnectorListRes {
	return &NullableConnectorListRes{value: val, isSet: true}
}
