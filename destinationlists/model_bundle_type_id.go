...
// BundleTypeId The type of the destination list. In your policy rules, the system applies security controls to your destination lists. **Note:** When you create a destination list, set the `bundleTypeId` to `2`.
