...
// APIClient manages communication with the Cisco Secure Access Destination Lists API API v1.0.0
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.DestinationListsAPI = (*DestinationListsAPIService)(&c.common)
