...
type DestinationListObject struct {
	...
	// The date and time when the system created the destination list.
	CreatedAt int64 `json:"createdAt"`
	// The date and time when the system modified the destination list.
	ModifiedAt int64 `json:"modifiedAt"`
	// Specifies whether MSP is the default.
	IsMspDefault bool `json:"isMspDefault"`
	// Specifies whether the system marks the destination list for deletion.
