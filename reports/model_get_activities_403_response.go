...
// checks if the GetActivities403Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetActivities403Response{}
...
type _GetActivities403Response GetActivities403Response
...
func (o *GetActivities403Response) UnmarshalJSON(data []byte) (err error) {
	varGetActivities403Response := _GetActivities403Response{}

	err = json.Unmarshal(data, &varGetActivities403Response)

	if err != nil {
		return err
	}

	*o = GetActivities403Response(varGetActivities403Response)
...
type NullableGetActivities403Response struct {
	value *GetActivities403Response
	isSet bool
}
...
func NewNullableGetActivities403Response(val *GetActivities403Response) *NullableGetActivities403Response {
	return &NullableGetActivities403Response{value: val, isSet: true}
}
