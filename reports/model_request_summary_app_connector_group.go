...
// checks if the RequestSummaryAppConnectorGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestSummaryAppConnectorGroup{}
...
type _RequestSummaryAppConnectorGroup RequestSummaryAppConnectorGroup

// NewRequestSummaryAppConnectorGroup instantiates a new RequestSummaryAppConnectorGroup object
...
func NewRequestSummaryAppConnectorGroup(count int64, unresolved int64) *RequestSummaryAppConnectorGroup {
	this := RequestSummaryAppConnectorGroup{}
	this.Count = count
	this.Unresolved = unresolved
	return &this
}

// NewRequestSummaryAppConnectorGroupWithDefaults instantiates a new RequestSummaryAppConnectorGroup object
...
func (o *RequestSummaryAppConnectorGroup) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestSummaryAppConnectorGroup := _RequestSummaryAppConnectorGroup{}

	err = json.Unmarshal(data, &varRequestSummaryAppConnectorGroup)

	if err != nil {
		return err
	}

	*o = RequestSummaryAppConnectorGroup(varRequestSummaryAppConnectorGroup)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "count")
		delete(additionalProperties, "unresolved")
...
type NullableRequestSummaryAppConnectorGroup struct {
	value *RequestSummaryAppConnectorGroup
	isSet bool
}
...
func NewNullableRequestSummaryAppConnectorGroup(val *RequestSummaryAppConnectorGroup) *NullableRequestSummaryAppConnectorGroup {
	return &NullableRequestSummaryAppConnectorGroup{value: val, isSet: true}
}
