...
// checks if the IdentityType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityType{}
...
type _IdentityType IdentityType
...
func (o *IdentityType) UnmarshalJSON(data []byte) (err error) {
	varIdentityType := _IdentityType{}

	err = json.Unmarshal(data, &varIdentityType)

	if err != nil {
		return err
	}

	*o = IdentityType(varIdentityType)
