...
// checks if the GetTotalRequests200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTotalRequests200Response{}
...
type _GetTotalRequests200Response GetTotalRequests200Response
...
func NewGetTotalRequests200Response(data TotalRequest, meta map[string]interface{}) *GetTotalRequests200Response {
	this := GetTotalRequests200Response{}
	this.Data = data
	this.Meta = meta
	return &this
}
...
func (o *GetTotalRequests200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTotalRequests200Response := _GetTotalRequests200Response{}

	err = json.Unmarshal(data, &varGetTotalRequests200Response)

	if err != nil {
		return err
	}

	*o = GetTotalRequests200Response(varGetTotalRequests200Response)
...
type NullableGetTotalRequests200Response struct {
	value *GetTotalRequests200Response
	isSet bool
}
...
func NewNullableGetTotalRequests200Response(val *GetTotalRequests200Response) *NullableGetTotalRequests200Response {
	return &NullableGetTotalRequests200Response{value: val, isSet: true}
}
