...
// checks if the GetUniqueResources200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUniqueResources200Response{}
...
type _GetUniqueResources200Response GetUniqueResources200Response
...
func NewGetUniqueResources200Response(data UniqueResources, meta map[string]interface{}) *GetUniqueResources200Response {
	this := GetUniqueResources200Response{}
	this.Data = data
	this.Meta = meta
	return &this
}
...
func (o *GetUniqueResources200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetUniqueResources200Response := _GetUniqueResources200Response{}

	err = json.Unmarshal(data, &varGetUniqueResources200Response)

	if err != nil {
		return err
	}

	*o = GetUniqueResources200Response(varGetUniqueResources200Response)
...
type NullableGetUniqueResources200Response struct {
	value *GetUniqueResources200Response
	isSet bool
}
...
func NewNullableGetUniqueResources200Response(val *GetUniqueResources200Response) *NullableGetUniqueResources200Response {
	return &NullableGetUniqueResources200Response{value: val, isSet: true}
}
