...
func (r ApiGetIdentityDistributionRequest) Execute() (*GetIdentityDistribution200Response, *http.Response, error) {
	return r.ApiService.GetIdentityDistributionExecute(r)
}
...
func (a *IdentityDistributionAPIService) GetIdentityDistributionExecute(r ApiGetIdentityDistributionRequest) (*GetIdentityDistribution200Response, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *GetIdentityDistribution200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IdentityDistributionAPIService.GetIdentityDistribution")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reports/v2/identity-distribution"
...
func (r ApiGetIdentityDistributionTypeRequest) Execute() (*GetIdentityDistributionType200Response, *http.Response, error) {
	return r.ApiService.GetIdentityDistributionTypeExecute(r)
}
...
func (a *IdentityDistributionAPIService) GetIdentityDistributionTypeExecute(r ApiGetIdentityDistributionTypeRequest) (*GetIdentityDistributionType200Response, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetIdentityDistributionType200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IdentityDistributionAPIService.GetIdentityDistributionType")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reports/v2/identity-distribution/{type}"
