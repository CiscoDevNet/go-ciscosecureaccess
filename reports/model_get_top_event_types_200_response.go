...
// checks if the GetTopEventTypes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTopEventTypes200Response{}
...
type _GetTopEventTypes200Response GetTopEventTypes200Response
...
func NewGetTopEventTypes200Response(data []TopEventType, meta map[string]interface{}) *GetTopEventTypes200Response {
	this := GetTopEventTypes200Response{}
	this.Data = data
	this.Meta = meta
	return &this
}
...
func (o *GetTopEventTypes200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTopEventTypes200Response := _GetTopEventTypes200Response{}

	err = json.Unmarshal(data, &varGetTopEventTypes200Response)

	if err != nil {
		return err
	}

	*o = GetTopEventTypes200Response(varGetTopEventTypes200Response)
...
type NullableGetTopEventTypes200Response struct {
	value *GetTopEventTypes200Response
	isSet bool
}
...
func NewNullableGetTopEventTypes200Response(val *GetTopEventTypes200Response) *NullableGetTopEventTypes200Response {
	return &NullableGetTopEventTypes200Response{value: val, isSet: true}
}
