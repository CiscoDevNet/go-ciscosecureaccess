...
// checks if the GetActivityZTNA200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetActivityZTNA200Response{}
...
type _GetActivityZTNA200Response GetActivityZTNA200Response

// NewGetActivityZTNA200Response instantiates a new GetActivityZTNA200Response object
...
func NewGetActivityZTNA200Response(data []ActivityZTNA, meta map[string]interface{}) *GetActivityZTNA200Response {
	this := GetActivityZTNA200Response{}
	this.Data = data
	this.Meta = meta
	return &this
}

// NewGetActivityZTNA200ResponseWithDefaults instantiates a new GetActivityZTNA200Response object
...
func (o *GetActivityZTNA200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetActivityZTNA200Response := _GetActivityZTNA200Response{}

	err = json.Unmarshal(data, &varGetActivityZTNA200Response)

	if err != nil {
		return err
	}

	*o = GetActivityZTNA200Response(varGetActivityZTNA200Response)
...
type NullableGetActivityZTNA200Response struct {
	value *GetActivityZTNA200Response
	isSet bool
}
...
func NewNullableGetActivityZTNA200Response(val *GetActivityZTNA200Response) *NullableGetActivityZTNA200Response {
	return &NullableGetActivityZTNA200Response{value: val, isSet: true}
}
