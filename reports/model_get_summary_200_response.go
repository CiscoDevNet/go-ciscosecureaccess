...
// checks if the GetSummary200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSummary200Response{}
...
type _GetSummary200Response GetSummary200Response
...
func (o *GetSummary200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSummary200Response := _GetSummary200Response{}

	err = json.Unmarshal(data, &varGetSummary200Response)

	if err != nil {
		return err
	}

	*o = GetSummary200Response(varGetSummary200Response)
...
func NewNullableGetSummary200Response(val *GetSummary200Response) *NullableGetSummary200Response {
	return &NullableGetSummary200Response{value: val, isSet: true}
}
