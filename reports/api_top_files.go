...
func (r ApiGetTopFilesProxyRequest) Execute() (*GetTopFilesProxy200Response, *http.Response, error) {
	return r.ApiService.GetTopFilesProxyExecute(r)
}
...
func (a *TopFilesAPIService) GetTopFilesProxyExecute(r ApiGetTopFilesProxyRequest) (*GetTopFilesProxy200Response, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *GetTopFilesProxy200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TopFilesAPIService.GetTopFilesProxy")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reports/v2/top-files"
