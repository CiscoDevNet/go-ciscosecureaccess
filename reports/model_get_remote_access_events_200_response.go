...
// checks if the GetRemoteAccessEvents200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRemoteAccessEvents200Response{}
...
type _GetRemoteAccessEvents200Response GetRemoteAccessEvents200Response
...
func NewGetRemoteAccessEvents200Response(data []RemoteAccess, meta map[string]interface{}) *GetRemoteAccessEvents200Response {
	this := GetRemoteAccessEvents200Response{}
	this.Data = data
	this.Meta = meta
	return &this
}
...
func (o *GetRemoteAccessEvents200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRemoteAccessEvents200Response := _GetRemoteAccessEvents200Response{}

	err = json.Unmarshal(data, &varGetRemoteAccessEvents200Response)

	if err != nil {
		return err
	}

	*o = GetRemoteAccessEvents200Response(varGetRemoteAccessEvents200Response)
...
type NullableGetRemoteAccessEvents200Response struct {
	value *GetRemoteAccessEvents200Response
	isSet bool
}
...
func NewNullableGetRemoteAccessEvents200Response(val *GetRemoteAccessEvents200Response) *NullableGetRemoteAccessEvents200Response {
	return &NullableGetRemoteAccessEvents200Response{value: val, isSet: true}
}
