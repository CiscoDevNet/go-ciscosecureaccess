...
// checks if the ProtocolObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtocolObject{}
...
type _ProtocolObject ProtocolObject
...
func (o *ProtocolObject) GetIdentitiesCount() int64 {
	if o == nil || IsNil(o.IdentitiesCount) {
		var ret int64
		return ret
	}
...
// GetIdentitiesCountOk returns a tuple with the IdentitiesCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func (o *ProtocolObject) UnmarshalJSON(data []byte) (err error) {
	varProtocolObject := _ProtocolObject{}

	err = json.Unmarshal(data, &varProtocolObject)

	if err != nil {
		return err
	}

	*o = ProtocolObject(varProtocolObject)
...
func NewNullableProtocolObject(val *ProtocolObject) *NullableProtocolObject {
	return &NullableProtocolObject{value: val, isSet: true}
}
