...
func (r ApiGetTopCategoriesRequest) Execute() (*GetTopCategories200Response, *http.Response, error) {
	return r.ApiService.GetTopCategoriesExecute(r)
}
...
func (a *TopCategoriesAPIService) GetTopCategoriesExecute(r ApiGetTopCategoriesRequest) (*GetTopCategories200Response, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *GetTopCategories200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TopCategoriesAPIService.GetTopCategories")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reports/v2/top-categories"
...
func (r ApiGetTopCategoriesTypeRequest) Execute() (*GetTopCategories200Response, *http.Response, error) {
	return r.ApiService.GetTopCategoriesTypeExecute(r)
}
...
func (a *TopCategoriesAPIService) GetTopCategoriesTypeExecute(r ApiGetTopCategoriesTypeRequest) (*GetTopCategories200Response, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TopCategoriesAPIService.GetTopCategoriesType")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reports/v2/top-categories/{type}"
