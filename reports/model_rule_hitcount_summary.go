...
// checks if the RuleHitcountSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleHitcountSummary{}
...
type _RuleHitcountSummary RuleHitcountSummary
...
func (o *RuleHitcountSummary) UnmarshalJSON(data []byte) (err error) {
	varRuleHitcountSummary := _RuleHitcountSummary{}

	err = json.Unmarshal(data, &varRuleHitcountSummary)

	if err != nil {
		return err
	}

	*o = RuleHitcountSummary(varRuleHitcountSummary)
...
func NewNullableRuleHitcountSummary(val *RuleHitcountSummary) *NullableRuleHitcountSummary {
	return &NullableRuleHitcountSummary{value: val, isSet: true}
}
