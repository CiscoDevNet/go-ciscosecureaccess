...
// checks if the GetActivityDns200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetActivityDns200Response{}
...
type _GetActivityDns200Response GetActivityDns200Response
...
func NewGetActivityDns200Response(data []ActivityDns, meta map[string]interface{}) *GetActivityDns200Response {
	this := GetActivityDns200Response{}
	this.Data = data
	this.Meta = meta
	return &this
}
...
func (o *GetActivityDns200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetActivityDns200Response := _GetActivityDns200Response{}

	err = json.Unmarshal(data, &varGetActivityDns200Response)

	if err != nil {
		return err
	}

	*o = GetActivityDns200Response(varGetActivityDns200Response)
...
type NullableGetActivityDns200Response struct {
	value *GetActivityDns200Response
	isSet bool
}
...
func NewNullableGetActivityDns200Response(val *GetActivityDns200Response) *NullableGetActivityDns200Response {
	return &NullableGetActivityDns200Response{value: val, isSet: true}
}
