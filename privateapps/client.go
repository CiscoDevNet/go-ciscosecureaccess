...
// APIClient manages communication with the Cisco Secure Access Private Resources and Resource Groups API API v1.0.0
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.PrivateResourcesAPI = (*PrivateResourcesAPIService)(&c.common)
