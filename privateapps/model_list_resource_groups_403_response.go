...
// checks if the ListResourceGroups403Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResourceGroups403Response{}
...
type _ListResourceGroups403Response ListResourceGroups403Response
...
func NewListResourceGroups403Response() *ListResourceGroups403Response {
	this := ListResourceGroups403Response{}
	return &this
}
...
func (o *ListResourceGroups403Response) UnmarshalJSON(data []byte) (err error) {
	varListResourceGroups403Response := _ListResourceGroups403Response{}

	err = json.Unmarshal(data, &varListResourceGroups403Response)

	if err != nil {
		return err
	}

	*o = ListResourceGroups403Response(varListResourceGroups403Response)
...
type NullableListResourceGroups403Response struct {
	value *ListResourceGroups403Response
	isSet bool
}

func (v NullableListResourceGroups403Response) Get() *ListResourceGroups403Response {
	return v.value
}

func (v *NullableListResourceGroups403Response) Set(val *ListResourceGroups403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListResourceGroups403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListResourceGroups403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResourceGroups403Response(val *ListResourceGroups403Response) *NullableListResourceGroups403Response {
	return &NullableListResourceGroups403Response{value: val, isSet: true}
}
