...
// checks if the ListResourceGroups500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResourceGroups500Response{}
...
type _ListResourceGroups500Response ListResourceGroups500Response

// NewListResourceGroups500Response instantiates a new ListResourceGroups500Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListResourceGroups500Response() *ListResourceGroups500Response {
	this := ListResourceGroups500Response{}
	return &this
}

// NewListResourceGroups500ResponseWithDefaults instantiates a new ListResourceGroups500Response object
...
func (o *ListResourceGroups500Response) UnmarshalJSON(data []byte) (err error) {
	varListResourceGroups500Response := _ListResourceGroups500Response{}

	err = json.Unmarshal(data, &varListResourceGroups500Response)

	if err != nil {
		return err
	}

	*o = ListResourceGroups500Response(varListResourceGroups500Response)
...
type NullableListResourceGroups500Response struct {
	value *ListResourceGroups500Response
	isSet bool
}

func (v NullableListResourceGroups500Response) Get() *ListResourceGroups500Response {
	return v.value
}

func (v *NullableListResourceGroups500Response) Set(val *ListResourceGroups500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListResourceGroups500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListResourceGroups500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResourceGroups500Response(val *ListResourceGroups500Response) *NullableListResourceGroups500Response {
	return &NullableListResourceGroups500Response{value: val, isSet: true}
}
