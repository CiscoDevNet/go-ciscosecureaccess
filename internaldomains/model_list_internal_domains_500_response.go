...
// checks if the ListInternalDomains500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListInternalDomains500Response{}
...
type _ListInternalDomains500Response ListInternalDomains500Response
...
func NewListInternalDomains500Response() *ListInternalDomains500Response {
	this := ListInternalDomains500Response{}
	return &this
}
...
func (o *ListInternalDomains500Response) UnmarshalJSON(data []byte) (err error) {
	varListInternalDomains500Response := _ListInternalDomains500Response{}

	err = json.Unmarshal(data, &varListInternalDomains500Response)

	if err != nil {
		return err
	}

	*o = ListInternalDomains500Response(varListInternalDomains500Response)
...
type NullableListInternalDomains500Response struct {
	value *ListInternalDomains500Response
	isSet bool
}

func (v NullableListInternalDomains500Response) Get() *ListInternalDomains500Response {
	return v.value
}

func (v *NullableListInternalDomains500Response) Set(val *ListInternalDomains500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalDomains500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalDomains500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalDomains500Response(val *ListInternalDomains500Response) *NullableListInternalDomains500Response {
	return &NullableListInternalDomains500Response{value: val, isSet: true}
}
