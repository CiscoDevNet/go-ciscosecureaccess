...
// checks if the SettingsRequestObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SettingsRequestObject{}
...
type _SettingsRequestObject SettingsRequestObject

// NewSettingsRequestObject instantiates a new SettingsRequestObject object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSettingsRequestObject() *SettingsRequestObject {
	this := SettingsRequestObject{}
	return &this
}

// NewSettingsRequestObjectWithDefaults instantiates a new SettingsRequestObject object
...
func (o *SettingsRequestObject) UnmarshalJSON(data []byte) (err error) {
	varSettingsRequestObject := _SettingsRequestObject{}

	err = json.Unmarshal(data, &varSettingsRequestObject)

	if err != nil {
		return err
	}

	*o = SettingsRequestObject(varSettingsRequestObject)
...
type NullableSettingsRequestObject struct {
	value *SettingsRequestObject
	isSet bool
}

func (v NullableSettingsRequestObject) Get() *SettingsRequestObject {
	return v.value
}

func (v *NullableSettingsRequestObject) Set(val *SettingsRequestObject) {
	v.value = val
	v.isSet = true
}

func (v NullableSettingsRequestObject) IsSet() bool {
	return v.isSet
}
...
func NewNullableSettingsRequestObject(val *SettingsRequestObject) *NullableSettingsRequestObject {
	return &NullableSettingsRequestObject{value: val, isSet: true}
}
