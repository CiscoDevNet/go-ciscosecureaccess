...
// checks if the NetworkTunnelGroupListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkTunnelGroupListResponse{}
...
type _NetworkTunnelGroupListResponse NetworkTunnelGroupListResponse
...
func NewNetworkTunnelGroupListResponse() *NetworkTunnelGroupListResponse {
	this := NetworkTunnelGroupListResponse{}
	return &this
}
...
func (o *NetworkTunnelGroupListResponse) UnmarshalJSON(data []byte) (err error) {
	varNetworkTunnelGroupListResponse := _NetworkTunnelGroupListResponse{}

	err = json.Unmarshal(data, &varNetworkTunnelGroupListResponse)

	if err != nil {
		return err
	}

	*o = NetworkTunnelGroupListResponse(varNetworkTunnelGroupListResponse)
...
type NullableNetworkTunnelGroupListResponse struct {
	value *NetworkTunnelGroupListResponse
	isSet bool
}

func (v NullableNetworkTunnelGroupListResponse) Get() *NetworkTunnelGroupListResponse {
	return v.value
}

func (v *NullableNetworkTunnelGroupListResponse) Set(val *NetworkTunnelGroupListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkTunnelGroupListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkTunnelGroupListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkTunnelGroupListResponse(val *NetworkTunnelGroupListResponse) *NullableNetworkTunnelGroupListResponse {
	return &NullableNetworkTunnelGroupListResponse{value: val, isSet: true}
}
